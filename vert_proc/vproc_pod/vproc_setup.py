...
def vprof_setup() :
    ...
    if 'revert' in case_types:
        ...
        pref_out = 'vpref_vres_revert_test'  
#        case_desc = ['rC5','rCE2i','rUW','rMG1','rC5p','rZMc','rpfrac']  
...
## Variables ##
    ...
    var_desc['DCQ']    = ['dq/dt Total',86400*1000.,1., -2.,2.,-2.,2.,'g/kg/day']
    ...
    var_desc['Q'] = ['Specific Humidity',1000., 1000., 0.,20.,-2.,2.,'g/kg']
