...
#			myfigs.scat_plot(case_type[icase],case,var_in_seas,varp_in_ps,reg_df,files_ptr,dir_proot)
#			myfigs.scat_plot(case_type[icase],case,var_in_nino,varp_in_ps,reg_df,files_ptr,dir_proot)
			myfigs.scat_plot(case_type[icase],case,var_in_nino,varp_in_ps,reg_df,files_ptr,dir_proot)
