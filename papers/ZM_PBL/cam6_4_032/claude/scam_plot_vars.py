...
#    vname = 'ZMMD' ; vscale = 3600. ; units2d='kg/m^2/hr' ; cmin = -8. ; cmax = 4. ; cmap = 'PuBuGn'
    
#    vname = 'ZMMTT' ; vscale = 86400. ; units2d='K/day' ; cmin = -0.1 ; cmax = 0.1 ; cmap = 'PuBuGn_r'
#    vname = 'ZMMTU' ; vscale = 86400. ; units2d='m/s/day' ; cmin = -4 ; cmax = 4. ; cmap = 'PuBuGn_r'
#    vname = 'ZMMTV' ; vscale = 86400. ; units2d='m/s/day' ; cmin = -4 ; cmax = 4. ; cmap = 'PuBuGn_r'
...
#    vname1d = 'PRECT' ; vscale1d = 86400.*1000. ;  units1d='mm/day' ; pmin = 0.01 ; pmax= 60. ; ovar1d = 'Prec' ; ovscale1d = 86400. 
    vname1d = 'TS' ; vscale1d = 1. ;  units1d='K' ; pmin = 280 ; pmax= 320. ; ovar1d = 'Tg' ; ovscale1d = 1. 
