...
### BASIC VARIABLES ###
var_r['wqsfc']   = ['Surface water vapor specific humidity flux','LHFLX','[m/s kg/kg]',Lv]  
var_r['wtsfc']   = ['Surface potential temperature flux','SHFLX','[mK/s]',cp_air] 
...
var_r['wt_r']   = ['Resolved vertical pot. temp. flux','WPTHLP_CLUBB','[mK/s]',1.]
var_r['qq_r']   = ['Resolved specific humidity variance','RTP2_CLUBB','[(kg/kg)^2]',1.]
var_r['wq_r']   = ['Resolved www triple-moment','WPRTP_CLUBB','[m/s kg/kg]',1.]
