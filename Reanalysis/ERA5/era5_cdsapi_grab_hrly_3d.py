...
var_get = 'dtdt_param'  ; param_num = '235005' ; var_name = 'mean_temperature_tendency_due_to_parametrisations'
...
dir_out = '/glade/derecho/scratch/rneale/ERA5/download/'+var_get+'/'
...
for yr in range(year0,year1+1):
    ...
    for month in range(1,13):
        ...
        mfile_out =   dir_out+var_get+'_'+str(yr)+'_'+str(f"{month:02d}")+'_ytest_era5_modelevs.grib' 
